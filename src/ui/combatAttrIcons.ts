...
export const COMBAT_ATTR_ICON_PATHS: Record<CombatAttrId, readonly string[]> = {
  ...
  fire: [
    'M8 1.1C9.7 3.55 12.4 5.35 12.4 8.7A4.4 4.4 0 1 1 3.65 8.15C4.55 6.2 6.15 5 6.95 3.15C7.25 4.75 8 5.8 9.05 6.45C8.15 5.05 7.85 3.05 8 1.1Z',
  ],
  ice: [
    'M7.4 1.15H8.6V14.85H7.4Z',
    'M1.15 7.4H14.85V8.6H1.15Z',
    'M3.2 2.9 4.1 2.15 12.8 13.1 11.9 13.85Z',
    'M11.9 2.15 12.8 2.9 4.1 13.85 3.2 13.1Z',
  ],
