...
export const COMBAT_ATTR_ICON_PATHS: Record<CombatAttrId, readonly string[]> = {
  ...
  dagger: ['M8 2.05 9.85 7.15H8.65V10.2L9.55 13.75H6.45L7.35 10.2V7.15H6.15Z'],
  axe: ['M11.55 1.7 14.15 4.3 11.2 8.55 9.45 6.8 4.15 14.55 2.7 13.25 8 5.7 6.25 3.95Z'],
  bow: [
  ...
  dark: ['M10.35 2.25A5.9 5.9 0 1 0 10.35 13.75 4.55 4.55 0 0 1 10.35 2.25Z'],
}
