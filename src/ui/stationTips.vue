...
import { useStationTips } from './stationTips'

const props = defineProps<{
  stationId: StationId
}>()

const { tips } = useStationTips(toRef(props, 'stationId'))
</script>
...
.tip {
  ...
  line-height: 1.4;
  text-align: center;
  animation: station-tip 1.4s ease-out forwards;
