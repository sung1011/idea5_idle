...
export const MODE_HELP: Record<ModeHelpId, ModeHelp> = {
  treasure: {
    ...
    rows: [
      {
        label: '怎么玩',
        text: '本地最多 4 个矿洞。守军是其他玩家的快照，不是联机实时，也不是 NPC。点抢夺，从休息工人里选最多 3 人开战；占领后点补采派人开采。',
      },
      {
        label: '规则要点',
        text: '储量 1000，约 1 小时或采空后消失并补洞。新洞守军大约各三分之一是 1、2、3 人，名字从玩家名里随机抽。连环 1v1，倒下立刻回休息。攻方胜则还活着的工人接着采原来的储量和倒计时。开采不装符文，抢夺可以装。弱点单独一行，开始全是问号；派开采或抢夺开战时揭开命中的。命中真实弱点让该工人开采快 1 秒，不看是否已揭开，也不改抢夺伤害。掉落进宝库（砂金 / 珠宝 / 古玉），不进工坊材料。',
      },
      {
        label: '注意',
        text: '同一洞抢夺进行中不能再开，也不能增援；别的洞照常。一方打完才解锁。宝库旁花 10 钻刷新：正在抢夺的洞留下，其余洞移除，我方开采工人回休息，再补满 4 洞。没有可刷的洞，或钻石不足，不扣钻。血条下 1/2/3 槽可点：有人看信息，空槽和已阵亡只漂字。',
      },
    ],
  },
  battlefield: {
