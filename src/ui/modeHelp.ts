...
export const MODE_HELP: Record<ModeHelpId, ModeHelp> = {
  treasure: {
    ...
    rows: [
      ...
      {
        label: '规则要点',
        text: '储量 1000，约 1 小时或采空后消失并补洞。新洞守军大约各三分之一是 1、2、3 人，名字从玩家名里随机抽。连环 1v1，倒下立刻回休息。攻方胜则还活着的工人接着采原来的储量和倒计时。开采不装符文，抢夺可以装。弱点只让命中的工人开采快 1 秒，不改抢夺伤害。掉落进宝库（砂金 / 珠宝 / 古玉），不进工坊材料。',
      },
      {
        label: '注意',
