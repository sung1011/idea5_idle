...
| PVP「夺宝矿洞」：本地 4 洞，影子守军，连环 1v1 抢夺后存活工人长采；按洞锁定，进行中禁止再开与增援；开采/抢夺与订单开战、增援共用选人面板，开采不显示符文槽；选中槽位按入队顺序标号，增援和补采从已占槽的下一号起；PVP 页签只有「夺宝」，矿洞卡对齐战场订单卡，卡头 tags 用战场词条芯片展示弱点，储量旁写消失倒计时，弱点命中开采 −1 秒；抢夺中当前攻守复用战场血条与出手条；宝库与工坊材料分开。底栏工坊｜PVE｜PVP｜科技；PVE 内页签战场｜地牢｜商场 | 真联机同洞对撞、聊天、公会 |
